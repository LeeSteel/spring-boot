 ...
 * <p>
 *
 * Spring的AOP支持的自动配置。相当于在配置中启用@EnableAspectJAutoProxy。
 * <p>
 *
 ...
 * <p>
 *
 * 如果spring.aop.auto=false，则不会激活配置。
 * 默认情况下，proxyTargetClass属性将为true，
 * 但可以通过指定spring.aop.proxyTargetClass=false来覆盖。
 * <p>
 *
 *
 * @author Dave Syer
